    ...
    <header className={styles['header']}>
        <div className={styles['header__container']}>
          <div className={styles['header__content']}>
            ...
            <div className={navToggler ? clsx(styles.navbarCollapse, styles.showNavbarCollapse) : styles.navbarCollapse}>
              <button type="button" className={styles['navbar-close-btn']} onClick={closeNavbar}>
                <FaTimes size={30} />
              </button>
              <ul className={styles['navbar-nav']}>
                <li className={styles['nav-item']}>
                  <Link to="/movies" className={styles['nav-link']} onClick={closeNavbar}><span>Movies</span></Link>
                </li>
                <li className={styles['nav-item']}>
                  <Link to="/favorite" className={styles['nav-link']} onClick={closeNavbar}><span>Favorite Movies</span></Link>
                </li>
              </ul>
            </div>
            <form
